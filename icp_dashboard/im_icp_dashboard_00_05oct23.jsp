				...
				<div>
					<table>
						<tr>
							...
							<td>Total Departure Footfall</td>
						</tr>
						<tr class="blue_faded">
...
<div class="row">
	...
	<div class="col-sm-3" >
			...
			<tr style="font-size: 40px;  text-align: right; color:white; border-color: #bae6ff;height:20px; ">
				<th colspan="2" style="text-align: center;background-color:#00539a;border-color: #00539a;width:40%;text-align: center;">Arrivals</th>
			</tr>
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
				<td style="background-color:#bae6ff;border-color: #bae6ff;width:20%; font-weight: bold; text-align: right;font-size: 50px;color: #00539a;"><%=today_Arrival_Count%></td>
				<td style="background-color:#bae6ff;border-color: #bae6ff;width:20%; font-weight: bold;text-align: left;color: #00539a;">&nbsp;&nbsp;Today's Footfall</td>
			</tr>
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
				<td  style="background-color:#bae6ff;border-color: #bae6ff;width:20%; font-weight: bold; text-align: right;font-size: 40px;color :#50b6ff"><%=yesterday_Arrival_Count%></td>
				<td style="background-color:#bae6ff;border-color: #bae6ff;width:20%; font-weight: bold;text-align: left;color :#50b6ff">&nbsp;&nbsp;Yesterday's Footfall</td>
			</tr>
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
				<td style="background-color:#bae6ff;border-color: #bae6ff;width:20%; font-weight: bold; text-align: right;">&nbsp;</td>
				<td style="background-color:#bae6ff;border-color: #bae6ff;width:20%; font-weight: bold;text-align: center;">&nbsp;</td>
			</tr>
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
				<td id="countArr" style="background-color:#bae6ff;border-color: #bae6ff;width:20%; font-weight: bold; text-align: right;font-size: 30px;color: #00539a;"></td>
				<td style="background-color:#bae6ff;border-color: #bae6ff;width:20%; font-weight: bold;text-align: left;color: #00539a;">&nbsp;&nbsp;Overall Footfall</td>
			</tr>
	...
	<div class="col-sm-2">
		...
		<table class="tableDesign">
			...
			<tr style="font-size: 40px;  text-align: right; color:white; border-color: #6929c4;height:20px; ">
				<th colspan="2" style="text-align: center;background-color:#6929c4;border-color: #6929c4;width:40%; text-align: center;">Departures</th>
			</tr>

			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
				
				<td style="background-color:#e8daff;border-color: #e8daff;width:20%; font-weight: bold; text-align: right;font-size: 50px;color: #6929c4;"><%=today_Dep_Count%></td>
				<td style="background-color:#e8daff;border-color: #e8daff;width:20%; font-weight: bold; text-align: left;color: #6929c4;">&nbsp;&nbsp;Today's Footfall</td>
			</tr>
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
				
				<td style="background-color:#e8daff;border-color: #e8daff;width:20%; font-weight: bold; text-align: right;font-size: 40px;color: #be95ff;"><%=yest_Dep_Count%></td>
				<td style="background-color:#e8daff;border-color: #e8daff;width:20%; font-weight: bold; text-align: left;color: #be95ff;">&nbsp;&nbsp;Yesterday's Footfall</td>
			</tr>
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
				
				<td style="background-color:#e8daff;border-color: #e8daff;width:20%; font-weight: bold; text-align: right;">&nbsp;</td>
				<td style="background-color:#e8daff;border-color: #e8daff;width:20%; font-weight: bold; text-align: right;">&nbsp;</td>
			</tr>
			<tr style="font-size: 14px; font-family: 'Arial', serif; text-align: center; border-color: #6929c4;height:18px;">
				
				<td id="count_total_Dep_Count" style="background-color:#e8daff;border-color: #e8daff;width:20%; font-weight: bold; text-align: right;font-size: 30px;color: #6929c4;">11,67,56,081
				<td style="background-color:#e8daff;border-color: #e8daff;width:20%; font-weight: bold; text-align: left;color: #6929c4;">&nbsp;&nbsp;Overall Footfall</td>
</td>
			</tr>
...
<section id="biometric_2"><br><br><br><br><br>
		...
		<table id = "auto-index9" class="table table-sm table-striped">
			<thead>
			<tr id='head1'>
					<th colspan=4 style="font-family: Arial;background-color: red; color: white; font-size: 22px;text-align: center;">End Of Report</th>
				</tr>
