...
<div class="row">
		<table class="tableDesign" style="width:35%;">
			<!--<caption style="font-size: 22px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Arrival and Departure Immigration Clearance in last 7 days</caption>-->
				...
				<tr style="font-size: 16px;  text-align: right; color:white; border-color: #00539a;height:40px;">
		...
		<% 
			...
			%>
			<tr style="font-size: 16px; font-family: 'Arial', serif; text-align: center; border-color: #00539a;height:18px;">
...
<%////////////////	Table -  Arrival and Departure Flights in last 7 days - Start	///////////////////////%>
		...
		<table class="tableDesign" style="width:35%;">
			...
			<tr style="font-size: 16px; font-family: 'Arial', serif;color: white; font-weight: bold; text-align: center;border-color: #f3342b;height:40px;">
				<th style="text-align: center;background-color:#f3342b;border-color: #f3342b;width:33.33%;">Date</th>
				<th style="text-align: center;background-color:#f3342b;border-color: #f3342b;width:33.33%; text-align: right;">Arrival Flights</th>
				<th style="text-align: center;background-color:#f3342b;border-color: #f3342b;width:33.33%; text-align: right;">Departure Flights</th>
			</tr>
		<% 
		...
		%>
			<tr style="font-size: 16px; font-family: 'Arial', serif; text-align: center;height:18px;border-color: #f3342b;">
				<td style="background-color:#f8857f;border-color: #f3342b;width:33.33%; font-weight: bold;"><%=weekListFlights[i]%></td>
				<td style="background-color:#faa7a4;border-color: #f3342b;width:33.33%;  text-align: right;"><%=weeklyArrFlights[i]%>&nbsp;&nbsp;&nbsp;</td>
				<td style="background-color:#fde0de;border-color: #f3342b;width:33.33%; font-weight: bold; text-align: right;"><%=weeklyDepFlights[i]%>&nbsp;&nbsp;&nbsp;</td>
			</tr>
<%
			}
			%>
...
<div class="row">
	<table class="tableDesign" style="width:32%;">
...
<% /////////////////	Table - Departure : PAX, Flight and Active Counters for last 7 hours - End	/////////////////////%>
	...
	<div class="column">
		<h1
			style="font-size: 15px; color: grey; line-height: 35px; text-align: center; padding-top: 5px; font-family: 'Arial', serif; background-color: #ffffff">Departure : PAX Clearance, Active Flights and Active Counters in last 7 hours
</h1>
