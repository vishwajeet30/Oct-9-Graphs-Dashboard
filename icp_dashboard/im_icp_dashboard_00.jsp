			...
			<div class="container"> 
			  ...
			  <div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav">
				  ...
				  <li> <a class="scrollLink dropdown-item" href="#ICS_Flight_Running_Status">Currently Running Flight Status in last 30 minutes</a></ul></li>
...
%> 
			...
			&nbsp;&nbsp;<button class="btn btn-primary" type="button" onClick="compare_report();"> Generate </button>
			...
			&nbsp;&nbsp;<button class="btn btn-primary" type="button" onClick="compare_hrs();"> Go </button>
...
%>
	...
	<%
	String hourlyBioQuery1 = "";
	String hourlyBioYAxis1 = "";
	int hourlyBioEnrolledCount1 = 0;
	int hourlyBioVerifiedCount1 = 0;
	int hourlyBioExemptedCount1 = 0;
	

	StringBuilder hourlyBio1 = new StringBuilder();
	StringBuilder hourlyBioEnrolled1 = new StringBuilder();
	StringBuilder hourlyBioVerified1 = new StringBuilder();
	StringBuilder hourlyBioExempted1 = new StringBuilder();

	flagFlightCount = false;
	try {
		hourlyBioQuery1 = "select * from (select to_date(to_char(pax_boarding_date,'dd/mm/yyyy')||':'||hours,'dd/mm/yyyy:HH24mi') as date_time, to_char(pax_boarding_date,'Mon-dd') as show_date,M0_M6,M6_Y1,Y1_Y5,Y5_Y10,Y10_Y20,Y20_Y30,Y30_Y40,Y40_Y50,Y50_Y60,Y60_Y70,Y70_Y80,Y80_Y90,Y90_Y100,Y100,icp_description,hours,HOURLY_BIO_ENROLLED,HOURLY_BIO_VERIFIED,HOURLY_BIO_EXEMPTED, table_type from im_dashboard_combined where pax_boarding_date >= trunc(sysdate-1) and table_type='IM_TRANS_ARR_TOTAL' and icp_srno = '"+ filter_icp +"' order by pax_boarding_date desc,HOURS desc ) where rownum<="+displayHours;
		psTemp = con.prepareStatement(hourlyBioQuery1);
		rsTemp = psTemp.executeQuery();
		while (rsTemp.next()) {			
			if (Integer.parseInt(rsTemp.getString("hours").substring(0,2)) >= 0 & Integer.parseInt(rsTemp.getString("hours").substring(0,2)) <= 11)
				//hourlyBioYAxis = rsTemp.getString("show_date") + " : " + rsTemp.getString("hours").substring(0,2) +" AM" ;
			...
			//out.println(hourlyVisaXAxis);
			hourlyBioEnrolledCount1 = rsTemp.getInt("M0_M6");
			hourlyBioVerifiedCount1 = rsTemp.getInt("M6_Y1");
			hourlyBioExemptedCount1 = rsTemp.getInt("Y1_Y5");
			//out.println(hourlyOCICount);

			if (flagFlightCount == true) {
				hourlyBio1.append(",");
				hourlyBioEnrolled1.append(",");
				hourlyBioVerified1.append(",");
				hourlyBioExempted1.append(",");
				} 
			else
				flagFlightCount = true;

			hourlyBio1.append("\"");
			hourlyBio1.append(hourlyBioYAxis);
			hourlyBio1.append("\"");
			
			hourlyBioEnrolled1.append(hourlyBioEnrolledCount1);
			hourlyBioVerified1.append(hourlyBioVerifiedCount1);
			hourlyBioExempted1.append(hourlyBioExemptedCount1);
		}
		rsTemp.close();
		psTemp.close();
	...
	String strHourlyBio1 = hourlyBio1.toString();
	String strHourlyBioEnrolled1 = hourlyBioEnrolled1.toString();
	String strHourlyBioVerified1 = hourlyBioVerified1.toString();
	String strHourlyBioExempted1 = hourlyBioExempted1.toString();
	//out.println(strHourlyOCI);
...
<div class="container-fluid">
	<div class="row">
		...
		<!--	<caption style="font-size: 15px; color: grey; line-height: 50px; text-align: center; padding-top: 5px;font-weight: bold; font-family: 'Arial', serif;">Biometric Enrollment/Verification/Exemption in last 7 hours</caption>-->
				...
				<tr style="font-size: 16px;  text-align: right; color:white; border-color: #003a6d;height:40px;">
					<th style="text-align: center;background-color:#00539a;border-color: #38acff;width:25%;">Time</th>
					<th style="text-align: center;background-color:#00539a;border-color: #38acff;width:25%; text-align: right;">M0_M6&nbsp;&nbsp;</th>
					<th style="text-align: center;background-color:#00539a;border-color: #38acff;width:25%; text-align: right;">M6_Y1&nbsp;&nbsp;</th>
					<th style="text-align: center;background-color:#00539a;border-color: #38acff;width:25%; text-align: right;">Y1_Y5&nbsp;&nbsp;</th>
				</tr>
		<% 
			String[] hourListBio1 = strHourlyBio1.toString().replace("\"", "").split(",");
			String[] hourBioEnrolled1 = strHourlyBioEnrolled1.split(",");
			String[] hourBioVerified1 = strHourlyBioVerified1.split(",");
			String[] hourBioExempted1 = strHourlyBioExempted1.split(",");
			//String v_date_Format  = "";
			/*String strHourlyBio = hourlyBio.toString();
			String strHourlyBioEnrolled = hourlyBioEnrolled.toString();
			String strHourlyBioVerified = hourlyBioVerified.toString();
			...
			%>
			<tr style="font-size: 16px; font-family: 'Arial', serif; text-align: center;height:20px;">
				<td style="background-color:#38acff;border-color: #00539a;width:25%; font-weight: bold; text-align: center;"><%=hourListBio1[i].equals("0") ? "&nbsp;" : hourListBio1[i]%></td>
				<td style="background-color:#50b6ff;border-color: #00539a;width:25%; font-weight: bold; text-align: right;"><%=hourBioEnrolled1[i].equals("0") ? "&nbsp;" : hourBioEnrolled1[i]%>&nbsp;&nbsp;</td>
				<td style="background-color:#86cdff;border-color: #00539a;width:25%; font-weight: bold; text-align: right;"><%=hourBioVerified1[i].equals("0") ? "&nbsp;" : hourBioVerified1[i]%>&nbsp;&nbsp;</td>
				<td style="background-color:#cceaff;border-color: #00539a;width:25%; font-weight: bold; text-align: right;"><%=hourBioExempted1[i].equals("0") ? "&nbsp;" : hourBioExempted1[i]%>&nbsp;&nbsp;</td>
			</tr>
<%
			}
			%>
